...
36       FORMAT(1X,'NUMBER OF RECTANGULAR SECTION GEOMETRIES = ', I10)
      ENDIF
C3B----READ OPTION FOR SAVING CLN OUTPUT AND UNIT NUMBER
...
C
   ...
   42   FORMAT(1X,'CLN CONC OUTPUT WILL BE SAVED TO THE SAME UNIT',1X,
     1   'NUMBER (ISPCUN) AS USED FOR CONC OUTPUT FOR POROUS MATRIX'
...
C  DEALLOCATE CLN DATA
      USE CLN1MODULE
C
ctm        DEALLOCATE(NCLN,ICLNCB,ICLNHD,ICLNDD,ICLNIB,NCLNNDS,ICLNCN)
