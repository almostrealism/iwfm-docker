...
! ******************************************************************
  ...
  ! -------------------------------------------------------------
  SUBROUTINE New(PondLand,IsForInquiry,cFileName,cWorkingDirectory,FactCN,AppGrid,iElemIDs,TimeStep,NTimeSteps,cIWFMVersion,iStat)
...
! ******************************************************************
  ...
  SUBROUTINE Simulate(PondedAg,AppGrid,ETData,DeltaT,Precip,GenericMoisture,SoilsData,HydCondPonded,ElemSupply,ElemsToGW,SolverData,lLakeElem,iStat)
    ...
    DO indxElem=1,AppGrid%NElements
        ...
        PondedAg%Crops(:,indxElem)%ETFromGW_Actual = 0.0
