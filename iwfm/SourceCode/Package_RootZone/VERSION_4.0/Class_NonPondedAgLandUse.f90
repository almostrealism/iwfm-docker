...
! ******************************************************************
  ...
  CONTAINS
    ...
    PROCEDURE,PASS :: ReadTSData         => NonPondedAgLandUse_ReadTSData      
...
! ******************************************************************
  ...
  ! -------------------------------------------------------------
  SUBROUTINE NonPondedAgLandUse_ReadTSData(AgLand,TimeStep,AppGrid,IrigPeriodFile,WiltingPoint,FieldCapacity,iStat)
