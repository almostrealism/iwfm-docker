...
! ******************************************************************
  ...
  CONTAINS
    ...
    PROCEDURE,PASS :: ReadTSData                     => AppStream_v40_ReadTSData
...
! ******************************************************************
  ...
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v40_SetDynamicComponent(AppStream,IsForInquiry,cFileName,cWorkingDirectory,TimeStep,NTIME,AppGrid,Stratigraphy,StrmLakeConnector,StrmGWConnector,iStat)
  ...
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v40_SetAllComponents(AppStream,IsForInquiry,cFileName,cSimWorkingDirectory,TimeStep,NTIME,AppGrid,Stratigraphy,BinFile,StrmLakeConnector,StrmGWConnector,iStat)
    CLASS(AppStream_v40_Type),INTENT(OUT) :: AppStream
    LOGICAL,INTENT(IN)                    :: IsForInquiry
    ...
    CALL AppStream_v40_SetDynamicComponent(AppStream,IsForInquiry,cFileName,cSimWorkingDirectory,TimeStep,NTIME,AppGrid,Stratigraphy,StrmLakeConnector,StrmGWConnector,iStat)
    IF (iStat .EQ. -1) RETURN
  ...
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v40_SetAllComponentsWithoutBinFile(AppStream,IsRoutedStreams,IsForInquiry,cPPFileName,cSimFileName,cSimWorkingDirectory,AppGrid,Stratigraphy,TimeStep,NTIME,StrmLakeConnector,StrmGWConnector,iStat)
    CLASS(AppStream_v40_Type),INTENT(OUT) :: AppStream
    ...
    CALL AppStream_v40_SetDynamicComponent(AppStream,IsForInquiry,cSimFileName,cSimWorkingDirectory,TimeStep,NTIME,AppGrid,Stratigraphy,StrmLakeConnector,StrmGWConnector,iStat)
    IF (iStat .EQ. -1) RETURN
...
! ******************************************************************
  ...
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v40_ReadTSData(AppStream,lDiverAdjusted,TimeStep,iStat,DiversionsOverwrite)
    CLASS(AppStream_v40_Type)     :: AppStream
  ...
  END SUBROUTINE AppStream_v40_ReadTSData
...
! ******************************************************************
  ...
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v40_WriteDataToTextFile(AppStream,UNITLTOU,FACTLTOU,Stratigraphy,StrmGWConnector,iStat)
    CLASS(AppStream_v40_Type),INTENT(IN)  :: AppStream
...
! ******************************************************************
  ...
  SUBROUTINE AppStream_v40_Simulate(AppStream,GWHeads,Runoff,ReturnFlow,TributaryFlow,DrainInflows,RiparianET,RiparianETFrac,StrmGWConnector,StrmLakeConnector,Matrix)
    ...
    !Local variables
    INTEGER                                 :: indxNode,indx,iNode,indxReach,NBypass,ErrorCode,iNodeIDs(1), &
                                               NNodes
    REAL(8)                                 :: rInflow,rOutflow,CoeffDiver,Bypass_Recieved,CoeffBypass,     &
                                               rUpdateValues(1),rValue,RHSMin,rDummyArray(1)
    ...
    INTEGER,PARAMETER                       :: iCompIDs_Connect(1) = iStrmComp  , &
