...
C              Copy single array to single
               DO 100 I=NSTART,ILIM
                  ...
                  IF (IFLAG.LT.0) THEN
                     IF (IFLAG.EQ.-1) THEN
                        IF ((BLOCK(M).NE.-901.0).AND.
     *                  (BLOCK(M).NE.-902.0)) GO TO 100
                     ELSE IF (IFLAG.EQ.-4) THEN
                        IF ((SVALUES(I).EQ.-901.0).OR.
     *              (SVALUES(I).EQ.-902.0)) GO TO 100
                     ENDIF
                  ENDIF
                  IF (LTOL) THEN
...
C              Copy double array to double
               DO 120 I=NSTART,ILIM
                  ...
                  IF (IFLAG.LT.0) THEN
                     IF (IFLAG.EQ.-1) THEN
                        IF ((DBLOCK(M).NE.-901.0).AND.
     *                  (DBLOCK(M).NE.-902.0)) GO TO 120
                     ELSE IF (IFLAG.EQ.-4) THEN
                        IF ((DVALUES(I).EQ.-901.0).OR.
     *                  (DVALUES(I).EQ.-902.0)) GO TO 120
                     ENDIF
                  ENDIF
                  IF (LTOL) THEN
...
C              Copy single array to double
               DO 140 I=NSTART,ILIM
                  ...
                  IF (IFLAG.LT.0) THEN
                     IF (IFLAG.EQ.-1) THEN
                        IF ((DBLOCK(M).NE.-901.0).AND.
     *                  (DBLOCK(M).NE.-902.0)) GO TO 140
                     ELSE IF (IFLAG.EQ.-4) THEN
                        IF ((SVALUES(I).EQ.-901.0).OR.
     *                  (SVALUES(I).EQ.-902.0)) GO TO 140
                     ENDIF
                  ENDIF
                  IF (LTOL) THEN
...
C           Copy single array to single
            ...
            DO 160 I=NSTART,ILIM
               ...
               IF (IFLAG.LT.0) THEN
                  IF (IFLAG.EQ.-1) THEN
                     IF ((BLOCK(M).NE.-901.0).AND.
     *               (BLOCK(M).NE.-902.0)) GO TO 160
                  ELSE IF (IFLAG.EQ.-4) THEN
                     IF ((SVALUES(I).EQ.-901.0).OR.
     *               (SVALUES(I).EQ.-902.0)) GO TO 160
                  ENDIF
               ENDIF
...
C           Copy double array to double
            ...
            DO 180 I=NSTART,ILIM
               ...
               IF (IFLAG.LT.0) THEN
                  IF (IFLAG.EQ.-1) THEN
                     IF ((DBLOCK(M).NE.-901.0).AND.
     *               (DBLOCK(M).NE.-902.0)) GO TO 180
                  ELSE IF (IFLAG.EQ.-4) THEN
                     IF ((DVALUES(I).EQ.-901.0).OR.
     *               (DVALUES(I).EQ.-902.0)) GO TO 180
                  ENDIF
               ENDIF
C              Check for quality protection bit
               IF (LQPBIT.AND.LQVALS) THEN
