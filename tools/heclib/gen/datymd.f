...
C         21 March  (return julian date for March 21 of the current yr)
...
C
      ...
      IF (ISTAT.NE.0) GO TO 900
C     If the length of the date is 2 digits, the current century is
C     assumed (Using this logic, the year 8 A.D. is represented by 0008)
