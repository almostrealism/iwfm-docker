...
C     IWORD(4) = -1                                                     E       big endian
      IWORD(4) = 0                                                      e       little endian
C
...
C     NRECL = NCPW * NBSIZE                                             Mp
      NRECL = NCPW * (NBSIZE + 1)                                       u
C
...
C     is assigned.
C     IF ((MLEVEL.GE.1).AND.(MUNIT.EQ.6)) THEN                          M
C       WRITE(UNIT=6,IOSTAT=IERR,FMT='(A)')' '                          M
C       IF (IERR.NE.0) THEN                                             M
C           MUNIT = 7                                                   M
C           OPEN(UNIT=7, STATUS='SCRATCH',IOSTAT=IERR)                  M
C        ENDIF                                                          M
C     ENDIF                                                             M
C
