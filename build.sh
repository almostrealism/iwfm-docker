...
docker build . -f Dockerfile.pmgr -t ashesfall/iwfm-parallel-mgr:1403
docker build . -f Dockerfile.pagt -t ashesfall/iwfm-parallel-agt:1403
...
docker push ashesfall/iwfm-parallel-mgr:1403
docker push ashesfall/iwfm-parallel-agt:1403
